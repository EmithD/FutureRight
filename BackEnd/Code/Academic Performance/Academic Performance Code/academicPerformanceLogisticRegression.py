...
train_data = pd.read_csv(
    "BackEnd\\Data\\SLALevelDataset\\Final_data_set\\Train.csv")
...
test_data = pd.read_csv(
    "BackEnd\\Data\\SLALevelDataset\\Final_data_set\\Test.csv")
...
print(academic_model.predict([[2, 31, 2, 11, 4, 8, 2, 0]]))
