...
edited['sub1_r'].replace(['A', 'B', 'C', 'S', 'F', 'Absent', 'Withheld'], [
...
edited['sub2_r'].replace(['A', 'B', 'C', 'S', 'F', 'Absent', 'Withheld'], [
                         0, 1, 2, 3, 4, 5, 6], inplace=True)
...
# replacing values in 'sub2_r' column
edited['sub3_r'].replace(['A', 'B', 'C', 'S', 'F', 'Absent', 'Withheld'], [
                         0, 1, 2, 3, 4, 5, 6], inplace=True)

# replacing values in 'sub2_r' column
edited['general_english_r'].replace(['A', 'B', 'C', 'S', 'F', 'Absent', 'Withheld'], [
                                    0, 1, 2, 3, 4, 5, 6], inplace=True)
